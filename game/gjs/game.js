...
async function getUserInfo(){
	userInfo = await gameContract.methods.getPlayerInfo().call({'from' : user.address})
	if(userInfo.participated)
		$('.user-guess')[0].innerHTML = userInfo.guessedNumber
}
